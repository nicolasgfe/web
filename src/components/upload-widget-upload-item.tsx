		...
		>
			<div className="flex flex-col gap-1">
				...
				<span className="text-xxs text-zinc-400 flex gap-1.5 items-center">
					...
					{upload.status === "canceled" && <span className="text-amber-400">Cancelado</span>}
				</span>
			</div>
			...
			>
				<Progress.Indicator
					className="bg-indigo-50 h-1 group-data-[status=success]:bg-green-400 group-data-[status=error]:bg-red-400 group-data-[status=canceled]:bg-yellow-400 transition-all"
